...
type Credentials struct {
	...
	Id string `json:"userId" db:"id" gorm:"primaryKey;unique"`
	// Email Address.
...
type IdMappings struct {
	...
	Id          string      `json:"userId" gorm:"constraint:OnUpdate:CASCADE,onDelete:SET NULL;"`
	Credentials Credentials `json:"Credentials" gorm:"constraint:OnUpdate:CASCADE,onDelete:SET NULL;"`
}
