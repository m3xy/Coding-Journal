...
type Project struct {
	...
	// name of the project
	Name string `json:"name" db:"projectName"`
	...
	MetaData *CodeProjectData `json:"metadata"`
}
...
// structure for meta-data about the project. matches the structure of the project's JSON data file
type CodeProjectData struct {
	// abstract for the project, to be displayed upon opening of any given project
	Abstract string `json:"abstract"`
	// reviewer comments on the overall project
